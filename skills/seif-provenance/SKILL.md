...
2. POST it to `https://api.seifprotocol.com/v1/sign`.
3. Return a shareable URL like `https://verify.seifprotocol.com/v1/evidence/<evidence_id>`.
...
|---|---|---|---|
| `SEIF_API_KEY` | yes | — | Authenticates the POST to `/v1/sign`. |
...
```json
{
  ...
  "signed_url": "https://verify.seifprotocol.com/v1/evidence/ev_<16-hex>",
